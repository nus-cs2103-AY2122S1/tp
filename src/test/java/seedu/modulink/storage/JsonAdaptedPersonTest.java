...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_ID, VALID_PHONE, VALID_EMAIL,
                    VALID_GITHUB_USERNAME, VALID_ISFAVOURITE, VALID_TAGS, VALID_ISMYPROFILE);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_ID, VALID_PHONE,
                VALID_EMAIL, VALID_GITHUB_USERNAME, VALID_ISFAVOURITE, VALID_TAGS, VALID_ISMYPROFILE);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_ID,
                null, VALID_EMAIL, VALID_GITHUB_USERNAME, VALID_ISFAVOURITE, VALID_TAGS, VALID_ISMYPROFILE);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_ID, VALID_PHONE, INVALID_EMAIL,
                        VALID_GITHUB_USERNAME, VALID_ISFAVOURITE,
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_ID,
                VALID_PHONE, null, VALID_GITHUB_USERNAME, VALID_ISFAVOURITE, VALID_TAGS, VALID_ISMYPROFILE);
    ...
    public void toModelType_nullStudentId_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, null,
                VALID_PHONE, VALID_EMAIL, VALID_GITHUB_USERNAME, VALID_ISFAVOURITE, VALID_TAGS, VALID_ISMYPROFILE);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_ID, VALID_PHONE,
                        VALID_EMAIL, VALID_GITHUB_USERNAME, VALID_ISFAVOURITE, invalidTags, VALID_ISMYPROFILE);
