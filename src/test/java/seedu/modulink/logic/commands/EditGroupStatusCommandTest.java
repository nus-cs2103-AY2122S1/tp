...
public class EditGroupStatusCommandTest {
    ...
    /* Need help! Don't know why these don't work
    @Test
    public void execute_editGroupStatusWithNoStatusChange_failure() throws CommandException {
        Person editedPerson = new PersonBuilder().withTags("CS2103T").buildProfile();
        model.addPerson(editedPerson);
        EditCommand.EditPersonDescriptor descriptor =
    ...
    @Test
    public void execute_editGroupStatusWhereModuleDoesNotExist_failure() throws CommandException {
