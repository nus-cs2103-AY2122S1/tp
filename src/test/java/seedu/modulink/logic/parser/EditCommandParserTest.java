...
import static seedu.modulink.testutil.TypicalIndexes.INDEX_THIRD_PERSON;
...
public class EditCommandParserTest {
    ...
    private static final String TAG_EMPTY = " " + PREFIX_MOD;
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_TAG_DESC, Mod.MESSAGE_CONSTRAINTS); // invalid tag
        ...
        assertParseFailure(parser, "1" + TAG_DESC_CS2100 + TAG_DESC_CS2103T + TAG_EMPTY, Mod.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, "1" + TAG_DESC_CS2100 + TAG_EMPTY + TAG_DESC_CS2103T, Mod.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, "1" + TAG_EMPTY + TAG_DESC_CS2100 + TAG_DESC_CS2103T, Mod.MESSAGE_CONSTRAINTS);
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TAG_DESC_CS2103T
                + EMAIL_DESC_AMY + NAME_DESC_AMY + TAG_DESC_CS2100;
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // tags
        userInput = targetIndex.getOneBased() + TAG_DESC_CS2100;
        descriptor = new EditPersonDescriptorBuilder().withTags(VALID_TAG_CS2100).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    }
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + EMAIL_DESC_AMY
                + TAG_DESC_CS2100 + PHONE_DESC_AMY + EMAIL_DESC_AMY + TAG_DESC_CS2100
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + TAG_DESC_CS2103T;

        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withPhone(VALID_PHONE_BOB)
                .withEmail(VALID_EMAIL_BOB).withTags(VALID_TAG_CS2100, VALID_TAG_CS2103T)
                .build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
