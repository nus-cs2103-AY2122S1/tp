...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonConthacksStorage addressBookStorage =
                new JsonConthacksStorage(temporaryFolder.resolve("addressBook.json"));
    ...
    public void execute_validCommand_success() throws Exception {
        assertCommandSuccess("list", ListPersonCommand.MESSAGE_SUCCESS, model);
    }

    @Test
    public void execute_storageThrowsIoException_throwsCommandException() {
        // Setup LogicManager with JsonConthacksIoExceptionThrowingStub
        JsonConthacksStorage addressBookStorage =
                new JsonConthacksIoExceptionThrowingStub(temporaryFolder.resolve("ioExceptionAddressBook.json"));
     ...
     */
    private static class JsonConthacksIoExceptionThrowingStub extends JsonConthacksStorage {
        private JsonConthacksIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }
