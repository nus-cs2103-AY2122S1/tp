...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonCsBookStorage csBookStorage =
                new JsonCsBookStorage(temporaryFolder.resolve("csBook.json"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(temporaryFolder.resolve("userPrefs.json"));
        StorageManager storage = new StorageManager(csBookStorage, userPrefsStorage);
    ...
    //        // Setup LogicManager with JsonCsBookIoExceptionThrowingStub
    //        JsonCsBookStorage addressBookStorage =
    //                new JsonCsBookIoExceptionThrowingStub(temporaryFolder
     ...
     */
    private static class JsonCsBookIoExceptionThrowingStub extends JsonCsBookStorage {
        private JsonCsBookIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }
