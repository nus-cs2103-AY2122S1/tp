...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonSportsPaStorage addressBookStorage =
                new JsonSportsPaStorage(temporaryFolder.resolve("sportsPa.json"));
    ...
    public void execute_commandExecutionError_throwsCommandException() {
        model.addMember(AMY);
        String deleteCommand = "deletem 9";
        assertCommandException(deleteCommand, String.format(Messages.MESSAGE_INVALID_MEMBER_DISPLAYED_INDEX));
    }
    ...
    public void execute_emptyList_throwsCommandException() {
        String listMemberCommand = ListMemberCommand.COMMAND_WORD;
        assertCommandException(listMemberCommand, String.format(Messages.MESSAGE_EMPTY_LIST, Messages.MESSAGE_MEMBER));
    }

    @Test
    public void execute_storageThrowsIoException_throwsCommandException() {
        // Setup LogicManager with JsonSportsPaIoExceptionThrowingStub
        JsonSportsPaStorage addressBookStorage =
                new JsonSportsPaIoExceptionThrowingStub(temporaryFolder.resolve("ioExceptionAddressBook.json"));
    ...
    public void getFilteredFacilityList_modifyList_throwsUnsupportedOperationException() {
        assertThrows(UnsupportedOperationException.class, () -> logic.getFilteredFacilityList().remove(0));
    }
     ...
     */
    private static class JsonSportsPaIoExceptionThrowingStub extends JsonSportsPaStorage {
        private JsonSportsPaIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }

        @Override
        public void saveSportsPa(ReadOnlySportsPa sportsPa, Path filePath) throws IOException {
