...
public class EditCommandParserTest {
    ...
    private static final String TAG_RATING = " " + PREFIX_RATING;
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TAG_DESC_HUSBAND + EMAIL_DESC_AMY
            + ADDRESS_DESC_AMY + NAME_DESC_AMY + TAG_DESC_FRIEND + RATING_DESC_AMY + REVIEW_DESC_AMY;
    ...
    @Test
    public void parse_resetRatings_success() {
        Index targetIndex = INDEX_THIRD_CONTACT;
        String userInput = targetIndex.getOneBased() + TAG_RATING;

        EditContactDescriptor descriptor = new EditContactDescriptorBuilder().withRating().build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
