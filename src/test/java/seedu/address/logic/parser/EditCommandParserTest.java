...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        String commandPrefix = " -i 1";
        assertParseFailure(parser, commandPrefix
        ...
        assertParseFailure(parser, commandPrefix + INVALID_PHONE_DESC + EMAIL_DESC_AMY, Phone.MESSAGE_CONSTRAINTS);

        // valid phone followed by invalid phone. The test case for invalid phone followed by valid phone
        // is tested at {@code parse_invalidValueFollowedByValidValue_success()}
        assertParseFailure(parser, commandPrefix + PHONE_DESC_BOB + INVALID_PHONE_DESC, Phone.MESSAGE_CONSTRAINTS);
        ...
        assertParseFailure(parser, commandPrefix
                        + INVALID_NAME_DESC + INVALID_EMAIL_DESC + VALID_PHONE_AMY, Name.MESSAGE_CONSTRAINTS);
    }
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        Index targetIndex = INDEX_FIRST_PERSON;
        String userInput = " " + PREFIX_DASH_INDEX.getPrefix() + targetIndex.getOneBased()
                + PHONE_DESC_AMY + EMAIL_DESC_AMY + TAG_DESC_FRIEND + PHONE_DESC_AMY + EMAIL_DESC_AMY + TAG_DESC_FRIEND
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        userInput = " " + PREFIX_DASH_INDEX.getPrefix()
                + targetIndex.getOneBased() + EMAIL_DESC_BOB + INVALID_PHONE_DESC + PHONE_DESC_BOB;
