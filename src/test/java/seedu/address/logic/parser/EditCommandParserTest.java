...
public class EditCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        Index targetIndex = INDEX_SECOND_PARTICIPANT;
    ...
    public void parse_someFieldsSpecified_success() {
        Index targetIndex = INDEX_FIRST_PARTICIPANT;
    ...
    public void parse_oneFieldSpecified_success() {
        // name
        Index targetIndex = INDEX_THIRD_PARTICIPANT;
        ...
        descriptor = new EditParticipantDescriptorBuilder().withAddress(VALID_ADDRESS_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // tags
        userInput = targetIndex.getOneBased() + TAG_DESC_FRIEND;
        descriptor = new EditParticipantDescriptorBuilder().withTags(VALID_TAG_FRIEND).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    }
    ...
    public void parse_resetTags_success() {
        ...
        EditParticipantDescriptor descriptor = new EditParticipantDescriptorBuilder().withTags().build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
