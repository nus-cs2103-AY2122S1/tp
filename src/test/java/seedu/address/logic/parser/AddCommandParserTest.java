...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + ROLE_DESC_BOB + EXPECTED_SALARY_DESC_BOB + EXPERIENCE_DESC_BOB
                        + TAG_DESC_FRIEND, new AddCommand(expectedPerson));

        // multiple names - last name accepted
        assertParseSuccess(parser, NAME_DESC_AMY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + ROLE_DESC_BOB + EXPECTED_SALARY_DESC_BOB
                + EXPERIENCE_DESC_BOB
                + TAG_DESC_FRIEND, new AddCommand(expectedPerson));
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + ROLE_DESC_BOB + EXPECTED_SALARY_DESC_AMY + EXPECTED_SALARY_DESC_BOB + EXPERIENCE_DESC_BOB
                        + TAG_DESC_FRIEND,
                new AddCommand(expectedPerson));

        // multiple roles - last role accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + ROLE_DESC_AMY + ROLE_DESC_BOB + EXPECTED_SALARY_DESC_BOB + EXPERIENCE_DESC_BOB + TAG_DESC_FRIEND,
                new AddCommand(expectedPerson));

        // multiple experiences - last experience accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + ROLE_DESC_BOB + EXPECTED_SALARY_DESC_BOB
                + EXPERIENCE_DESC_AMY + EXPERIENCE_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedPerson));

        // multiple tags - all accepted
        Person expectedPersonMultipleTags = new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .build();
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + ROLE_DESC_BOB + EXPECTED_SALARY_DESC_BOB + EXPERIENCE_DESC_BOB + TAG_DESC_HUSBAND
                        + TAG_DESC_FRIEND,
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + ROLE_DESC_AMY + EXPECTED_SALARY_DESC_AMY + EXPERIENCE_DESC_AMY, new AddCommand(expectedPerson));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser,
                VALID_NAME_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + ROLE_DESC_BOB + EXPECTED_SALARY_DESC_BOB + EXPERIENCE_DESC_BOB, expectedMessage);
        ...
        assertParseFailure(parser,
                NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + VALID_ROLE_BOB + EXPECTED_SALARY_DESC_BOB + EXPERIENCE_DESC_BOB, expectedMessage);

        // missing expected salary prefix
        assertParseFailure(parser,
                NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + VALID_ADDRESS_BOB
                        + ROLE_DESC_BOB + VALID_EXPECTED_SALARY_BOB + EXPERIENCE_DESC_BOB, expectedMessage);

        // missing experience prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + ROLE_DESC_BOB + EXPECTED_SALARY_DESC_BOB + VALID_EXPERIENCE_BOB,
                expectedMessage);

        // all prefixes missing
        assertParseFailure(parser,
                VALID_NAME_BOB + VALID_PHONE_BOB + VALID_EMAIL_BOB + VALID_ADDRESS_BOB
                        + VALID_ROLE_BOB + VALID_EXPECTED_SALARY_BOB + VALID_EXPERIENCE_BOB, expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid role
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INVALID_ROLE_DESC + EXPECTED_SALARY_DESC_BOB + EXPERIENCE_DESC_BOB + TAG_DESC_HUSBAND
                + VALID_TAG_FRIEND, Role.MESSAGE_CONSTRAINTS);

        // invalid expected salary
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + ROLE_DESC_BOB + INVALID_EXPECTED_SALARY_DESC + EXPERIENCE_DESC_BOB + TAG_DESC_HUSBAND
                        + TAG_DESC_FRIEND,
        ...
        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + ROLE_DESC_BOB + EXPECTED_SALARY_DESC_BOB + EXPERIENCE_DESC_BOB
                        + INVALID_TAG_DESC
        ...
        assertParseFailure(parser,
                INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC
                        + ROLE_DESC_BOB + EXPECTED_SALARY_DESC_BOB + EXPERIENCE_DESC_BOB, Name.MESSAGE_CONSTRAINTS);

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ROLE_DESC_BOB + EXPECTED_SALARY_DESC_BOB + EXPERIENCE_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND
                        + TAG_DESC_FRIEND,
