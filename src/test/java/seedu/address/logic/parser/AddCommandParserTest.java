...
public class AddCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + ROLE_DESC_BOB + EMPLOYMENT_TYPE_DESC_BOB + EXPECTED_SALARY_DESC_BOB + EXPERIENCE_DESC_BOB
        ...
        // invalid role
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INVALID_ROLE_DESC + EMPLOYMENT_TYPE_DESC_BOB + EXPECTED_SALARY_DESC_BOB + EXPERIENCE_DESC_BOB
                + TAG_DESC_HUSBAND + VALID_TAG_FRIEND, Role.MESSAGE_CONSTRAINTS);

        // invalid employment type
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + ROLE_DESC_BOB + INVALID_EMPLOYMENT_TYPE_DESC + EXPECTED_SALARY_DESC_BOB + EXPERIENCE_DESC_BOB
                + TAG_DESC_HUSBAND + VALID_TAG_FRIEND, EmploymentType.MESSAGE_CONSTRAINTS);


        // invalid expected salary
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + ROLE_DESC_BOB + EMPLOYMENT_TYPE_DESC_BOB + INVALID_EXPECTED_SALARY_DESC + EXPERIENCE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, ExpectedSalary.MESSAGE_CONSTRAINTS);

        // invalid experience
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + ROLE_DESC_BOB + EMPLOYMENT_TYPE_DESC_BOB + EXPECTED_SALARY_DESC_BOB + INVALID_EXPERIENCE_DESC
