...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        Person expectedPersonMultipleTags = new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_CLASSMATE)
                .build();
        assertParseSuccess(parser, NAME_DESC_BOB + EMAIL_DESC_BOB
                + TAG_DESC_CLASSMATE + FACULTY_DESC_BOB + MAJOR_DESC_BOB
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_NAME_BOB + EMAIL_DESC_BOB
                + FACULTY_DESC_BOB + MAJOR_DESC_BOB, expectedMessage);
        ...
        assertParseFailure(parser, NAME_DESC_BOB + EMAIL_DESC_BOB
                + VALID_FACULTY_BOB + MAJOR_DESC_BOB, expectedMessage);

        // missing major prefix
        assertParseFailure(parser, NAME_DESC_BOB + EMAIL_DESC_BOB
                + FACULTY_DESC_BOB + VALID_MAJOR_BOB, expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_BOB + VALID_EMAIL_BOB
                + VALID_FACULTY_BOB + VALID_MAJOR_BOB, expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + EMAIL_DESC_BOB
                + FACULTY_DESC_BOB + MAJOR_DESC_BOB
                + TAG_DESC_CLASSMATE + TAG_DESC_FRIEND, Name.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_EMAIL_DESC
                 + FACULTY_DESC_BOB + MAJOR_DESC_BOB
                + TAG_DESC_CLASSMATE + TAG_DESC_FRIEND, Email.MESSAGE_CONSTRAINTS);

        // invalid faculty
        assertParseFailure(parser, NAME_DESC_BOB + EMAIL_DESC_BOB
                + INVALID_FACULTY_DESC + MAJOR_DESC_BOB
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + EMAIL_DESC_BOB
                + INVALID_FACULTY_DESC + MAJOR_DESC_BOB, Name.MESSAGE_CONSTRAINTS);
