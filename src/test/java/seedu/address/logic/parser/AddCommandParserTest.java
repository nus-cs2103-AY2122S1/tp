...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + CATEGORY_DESC_OTH + NAME_DESC_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_FRIEND + RATING_DESC_BOB,
        ...
        assertParseSuccess(parser, CATEGORY_DESC_OTH + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_AMY + ADDRESS_DESC_BOB + TAG_DESC_FRIEND + RATING_DESC_BOB,
            new AddCommand(expectedPerson));
        ...
        assertParseSuccess(parser, CATEGORY_DESC_OTH + CATEGORY_DESC_OTH + NAME_DESC_BOB + PHONE_DESC_BOB
                ...
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + RATING_DESC_BOB, new AddCommand(expectedPersonMultipleTags));
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        // TODO(HK)[BUG]: Category code cannot be placed before INVALID_NAME_DESC
        ...
        // TODO(HK)[BUG]: Category code cannot be placed before PREAMBLE_NON_EMPTY
        // non-empty preamble
