...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        // multiple remarks - last fee accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + PARENT_PHONE_DESC_BOB + PARENT_EMAIL_DESC_BOB + ADDRESS_DESC_BOB + FEE_DESC_AMY + FEE_DESC_BOB
                + REMARK_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedPerson));

        // multiple remarks - last remark accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + PARENT_PHONE_DESC_BOB + PARENT_EMAIL_DESC_BOB + ADDRESS_DESC_BOB + FEE_DESC_BOB
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + PARENT_PHONE_DESC_BOB + PARENT_EMAIL_DESC_BOB + FEE_DESC_BOB + REMARK_DESC_BOB
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        Person expectedPerson = new PersonBuilder(AMY).withEmail("")
                .withParentPhone("").withParentEmail("").withFee("").withRemark("").withTags().build();
