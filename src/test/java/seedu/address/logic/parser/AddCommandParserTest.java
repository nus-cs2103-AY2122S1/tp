...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + REMARK_DESC_BOB + NATIONALITY_DESC_BOB + TUTORIAL_GROUP_DESC_BOB + TAG_DESC_FRIEND, 
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + NATIONALITY_DESC_AMY
                + REMARK_DESC_BOB + NATIONALITY_DESC_BOB + TUTORIAL_GROUP_DESC_AMY + TUTORIAL_GROUP_DESC_BOB
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + NATIONALITY_DESC_BOB
                + TUTORIAL_GROUP_DESC_BOB + TAG_DESC_HUSBAND + REMARK_DESC_BOB + TAG_DESC_FRIEND,
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + REMARK_DESC_AMY 
                        + NATIONALITY_DESC_AMY + TUTORIAL_GROUP_DESC_AMY, new AddCommand(expectedPerson));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_NAME_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + REMARK_DESC_BOB 
                           + NATIONALITY_DESC_BOB + TUTORIAL_GROUP_DESC_BOB, expectedMessage);
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + REMARK_DESC_BOB
                           + VALID_NATIONALITY_BOB + TUTORIAL_GROUP_DESC_BOB, expectedMessage);

        // missing tutorial group prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + REMARK_DESC_BOB
                           + NATIONALITY_DESC_BOB + VALID_TUTORIAL_GROUP_BOB, expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_BOB + VALID_PHONE_BOB + VALID_EMAIL_BOB + VALID_REMARK_BOB
                           + VALID_NATIONALITY_BOB + VALID_TUTORIAL_GROUP_BOB, expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + REMARK_DESC_BOB
                + NATIONALITY_DESC_BOB + TUTORIAL_GROUP_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Name.MESSAGE_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_PHONE_DESC + EMAIL_DESC_BOB + REMARK_DESC_BOB
                + NATIONALITY_DESC_BOB + TUTORIAL_GROUP_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Phone.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + INVALID_EMAIL_DESC + REMARK_DESC_BOB
                + NATIONALITY_DESC_BOB + TUTORIAL_GROUP_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Email.MESSAGE_CONSTRAINTS);
        ...
        // invalid nationality
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + REMARK_DESC_BOB
                + INVALID_NATIONALITY_DESC + TUTORIAL_GROUP_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Nationality.MESSAGE_CONSTRAINTS);

        // invalid tutorial group
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + REMARK_DESC_BOB
                + NATIONALITY_DESC_BOB + INVALID_TUTORIAL_GROUP_DESC + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, TutorialGroup.MESSAGE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + REMARK_DESC_BOB
                + NATIONALITY_DESC_BOB + TUTORIAL_GROUP_DESC_BOB + INVALID_TAG_DESC + VALID_TAG_FRIEND, Tag.MESSAGE_CONSTRAINTS);
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + 
                REMARK_DESC_BOB + NATIONALITY_DESC_BOB + TUTORIAL_GROUP_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
