...
public class SetRoleReqCommandParserTest {
    ...
    public void parse_validArgs_returnsSetRoleReqCommand() {
        ...
        assertParseSuccess(parser, " " + PREFIX_ROLE + "kitchen-1 " + PREFIX_ROLE + "bartender-1",
        ...
        assertParseSuccess(parser, "  " + PREFIX_ROLE + "floor-2  \n",
    ...
    public void parse_invalidArgs_returnsHelpMessage() {
        // Invalid inputs
        assertParseFailure(parser, " " + PREFIX_ROLE + "kitchen ",
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, SetRoleReqCommand.getHelpMessage()));
        assertParseFailure(parser, " " + PREFIX_ROLE + "1 ",
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, SetRoleReqCommand.getHelpMessage()));

        // Role that does not exist
        assertParseFailure(parser, " " + PREFIX_ROLE + "cashier-1 ",
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, SetRoleReqCommand.getHelpMessage()));
    }
}
