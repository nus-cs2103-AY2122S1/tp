...
class EmdelCommandParserTest {
    private EmdelCommandParser parser = new EmdelCommandParser();
    ...
    void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, EVENT_INDEX_DESC_ONE + MEMBER_INDEX_DESC_ONE,
                new EmdelCommand(expectedEventId, expectedMemberIdList));
    }

    @Test
    public void parse_compulsoryFieldMissing_failure() {
        String expectedMessage = String.format(MESSAGE_INVALID_COMMAND_FORMAT, EmdelCommand.MESSAGE_USAGE);
