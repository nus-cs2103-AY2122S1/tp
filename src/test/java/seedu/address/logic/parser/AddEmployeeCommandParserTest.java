...
public class AddEmployeeCommandParserTest {
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + VALID_LEAVES_BOB + SALARY_DESC_BOB + JOBTITLE_DESC_BOB,
                expectedMessage);

        // missing salary prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + LEAVES_DESC_BOB + VALID_SALARY_BOB + JOBTITLE_DESC_BOB,
                expectedMessage);

        // missing jobTitle prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + LEAVES_DESC_BOB + SALARY_DESC_BOB + VALID_JOBTITLE_BOB,
                expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_BOB + VALID_PHONE_BOB + VALID_EMAIL_BOB + VALID_ADDRESS_BOB
                + VALID_LEAVES_BOB + VALID_SALARY_BOB + VALID_JOBTITLE_BOB,
                expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        //invalid leaves
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INVALID_LEAVES_DESC + SALARY_DESC_BOB + JOBTITLE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Leaves.MESSAGE_CONSTRAINTS);

        //invalid salary
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + LEAVES_DESC_BOB + INVALID_SALARY_DESC + JOBTITLE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Salary.MESSAGE_CONSTRAINTS);

        //invalid job title
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + LEAVES_DESC_BOB + SALARY_DESC_BOB + INVALID_JOBTITLE_DESC
