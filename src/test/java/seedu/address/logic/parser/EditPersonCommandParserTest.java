...
public class EditPersonCommandParserTest {
    ...
    public void parse_missingParts_failure() {
        // no index specified
        assertParseFailure(parser, VALID_NAME_AMY, INVALID_COMMAND_INVALID_INDEX);
    ...
    public void parse_invalidPreamble_failure() {
        ...
        assertParseFailure(parser, "1 some random string", INVALID_COMMAND_INVALID_INDEX);

        // invalid prefix being parsed as preamble
        assertParseFailure(parser, "1 i/ string", INVALID_COMMAND_INVALID_INDEX);
    }
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditPersonCommand expectedCommand = new EditPersonCommand(targetIndex, descriptor, MESSAGE_EDIT_PERSON_SUCCESS);
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        expectedCommand = new EditPersonCommand(targetIndex, descriptor, MESSAGE_EDIT_PERSON_SUCCESS);
        assertParseSuccess(parser, userInput, expectedCommand);
