...
import static seedu.address.logic.commands.CommandTestUtil.INVALID_SPECIAL_REQUESTS_DESC;
...
public class EditCustomerCommandParserTest {
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // allergies
        userInput = targetIndex.getOneBased() + ALLERGY_DESC_GRAPEFRUITS;
        descriptor = new EditCustomerDescriptorBuilder().withAllergies(VALID_ALLERGY_GRAPEFRUITS).build();
        expectedCommand = new EditCustomerCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
        // special requests
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY
                ...
                + PHONE_DESC_BOB + ADDRESS_DESC_BOB + EMAIL_DESC_BOB + TAG_DESC_HUSBAND + LP_DESC_AMY;

        EditCustomerDescriptor descriptor =
                new EditCustomerDescriptorBuilder().withPhone(VALID_PHONE_BOB)
                        .withLoyaltyPoints(VALID_LP_AMY).withEmail(VALID_EMAIL_BOB)
    ...
    public void parse_resetAllergies_success() {
        ...
        EditCustomerDescriptor descriptor = new EditCustomerDescriptorBuilder().withAllergies().build();
        EditCustomerCommand expectedCommand = new EditCustomerCommand(targetIndex, descriptor);
