...
public class RemarkPersonCommandParserTest {
    private RemarkPersonCommandParser parser = new RemarkPersonCommandParser();
    ...
    public void parse_indexSpecified_success() {
        ...
        RemarkPersonCommand expectedCommand = new RemarkPersonCommand(INDEX_FIRST, new Remark(nonEmptyRemark));
        assertParseSuccess(parser, userInput, expectedCommand);

        // no remark
        userInput = targetIndex.getOneBased() + " " + PREFIX_REMARK;
        expectedCommand = new RemarkPersonCommand(INDEX_FIRST, new Remark(""));
        assertParseSuccess(parser, userInput, expectedCommand);
    }
