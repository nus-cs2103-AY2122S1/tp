...
public class DeleteLastMarkCommandParserTest {

    private static final String TAG_EMPTY = " " + PREFIX_TAG;

    private static final String MESSAGE_INVALID_FORMAT =
            String.format(MESSAGE_INVALID_STUDENT_DISPLAYED_INDEX + MESSAGE_INVALID_COMMAND_FORMAT,
                    DeleteLastMarkCommand.MESSAGE_USAGE);

    private DeleteLastMarkCommandParser parser = new DeleteLastMarkCommandParser();
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        DeleteLastMarkCommand expectedCommand = null;
        try {
