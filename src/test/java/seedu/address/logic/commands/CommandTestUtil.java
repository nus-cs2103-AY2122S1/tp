...
public class CommandTestUtil {
    ...
    public static final String VALID_BIRTHDAY_AMY = "1987-08-15";
    ...
    public static final String INVALID_BIRTHDAY_DESC = " " + PREFIX_BIRTHDAY + "2020-Jan-12"; // only numbers are allowed
