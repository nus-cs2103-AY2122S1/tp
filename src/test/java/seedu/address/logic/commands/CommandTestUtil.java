...
public class CommandTestUtil {
    ...
    public static final String INVALID_MEASUREMENT_DESC = " " + PREFIX_MEASUREMENT + "170_91"; //missing one measurement
    public static final String INVALID_ADDRESS_DESC = " " + PREFIX_ADDRESS; // empty string not allowed for addresses
    public static final String INVALID_REMARK_DESC = " " + PREFIX_REMARK + "^happy"; // '^' not allowed in tags
