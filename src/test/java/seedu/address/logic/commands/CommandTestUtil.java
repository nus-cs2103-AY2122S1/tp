...
public class CommandTestUtil {
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withRemark(REMARK_DESC_AMY).withTutorialGroup(VALID_TUTORIAL_GROUP_AMY).withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withNationality(VALID_NATIONALITY_BOB)
                .withRemark(REMARK_DESC_BOB).withTutorialGroup(VALID_TUTORIAL_GROUP_BOB)
