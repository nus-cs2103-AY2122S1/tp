...
public class CommandTestUtil {
    ...
    public static final String VALID_FILENAME_FRIENDS = "friends";
    ...
    public static final String INVALID_TELEGRAM_DESC = " " + PREFIX_TELEGRAM + "cannot!"; // '!' not allowed in telegram
    public static final String INVALID_GITHUB_DESC = " " + PREFIX_GITHUB + "a--b"; // '--' not allowed in github
