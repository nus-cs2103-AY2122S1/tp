...
public class CommandTestUtil {
    ...
    public static final String DESCRIPTION_DESC_FRIEND = " " + PREFIX_DESCRIPTION + VALID_TAG_FRIEND;
    public static final String DESCRIPTION_DESC_HUSBAND = " " + PREFIX_DESCRIPTION + VALID_TAG_HUSBAND;
