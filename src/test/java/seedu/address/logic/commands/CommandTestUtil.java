...
public class CommandTestUtil {
    ...
    public static final String INVALID_TELEGRAM_DESC = " " + PREFIX_TELEGRAM + "cannot!!!"; // '!' not allowed in names
    ...
    static {
        ...
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                ...
                .withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).withTelegram(VALID_TELEGRAM_BOB).build();
    }
