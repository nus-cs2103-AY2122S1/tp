...
public class EditCustomerDescriptorBuilder {
    ...
    public EditCustomerDescriptorBuilder(Customer customer) {
        ...
        descriptor.setLoyaltyPoints(customer.getLoyaltyPoints());
        descriptor.setAllergies(customer.getAllergies());
        descriptor.setSpecialRequests(customer.getSpecialRequests());
    ...
    /**
     * Sets the {@code LoyaltyPoints} of the {@code EditCustomerDescriptor} that we are building.
     */
    public EditCustomerDescriptorBuilder withLoyaltyPoints(String loyaltyPoints) {
        descriptor.setLoyaltyPoints(new LoyaltyPoints(loyaltyPoints));
        return this;
    }

    /**
     * Sets the {@code Allergies} of the {@code EditCustomerDescriptor} that we are building.
     */
    ...
    /**
     * Sets the {@code Set<SpecialRequest>} of the {@code EditCustomerDescriptor} that we are building.
     */
    public EditCustomerDescriptorBuilder withSpecialRequests(String... specialRequests) {
        Set<SpecialRequest> srSet = Stream.of(specialRequests).map(SpecialRequest::new).collect(Collectors.toSet());
        descriptor.setSpecialRequests(srSet);
        return this;
    }
