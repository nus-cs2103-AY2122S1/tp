...
public class TypicalEmployees {
    ...
    public static final Employee ALICE_EMPLOYEE = new EmployeeBuilder().withName("Alice Pauline")
            ...
            .withTags("friends").withShifts("2021-12-10 0800").build();
