...
public class PersonUtil {
    ...
    public static String getPersonDetails(Person person) {
        ...
        sb.append(PREFIX_NAME + person.getFullName() + " ");
        sb.append(PREFIX_PHONE + person.getPhoneValue() + " ");
        sb.append(PREFIX_EMAIL + person.getEmailValue() + " ");
        sb.append(PREFIX_ADDRESS + person.getAddressValue() + " ");
