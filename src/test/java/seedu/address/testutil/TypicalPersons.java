...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline").withGender("FEMALE")
            ...
            .withMeasurement("160_50_60_70")
            .withPhone("94351253").withRemark("dummy remark")
            .withTags("friends").build();
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier").withGender("MALE")
            .withAddress("311, Clementi Ave 2, #02-25")
            .withEmail("johnd@example.com").withPhone("98765432")
            .withMeasurement("170_80_90")
            .withRemark("son of Bento")
            .withTags("owesMoney", "friends").build();
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withGender("MALE")
            .withPhone("95352563")
            .withEmail("heinz@example.com").withAddress("wall street")
            .withMeasurement("175_90_110")
            .withRemark("only free on Sunday").build();
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier").withGender("MALE")
            .withPhone("87652533")
            .withEmail("cornelia@example.com").withAddress("10th street")
            .withMeasurement("172_85_105")
            .withRemark("high schooler").withTags("friends").build();
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withGender("MALE")
            .withPhone("9482224")
            .withEmail("werner@example.com").withAddress("michegan ave")
            .withMeasurement("175_90_110")
            .withRemark("loves pink").build();
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withGender("FEMALE")
            .withPhone("9482427")
            .withEmail("lydia@example.com").withAddress("little tokyo")
            .withMeasurement("160_50_60_70")
            .withRemark("").build();
    public static final Person JOHNSON = new PersonBuilder().withName("Johnson").withGender("MALE")
            .withPhone("9482442")
    ...
    public static final Person HOON = new PersonBuilder().withName("Hoon Meier").withGender("MALE").withPhone("8482424")
            .withMeasurement("100_30_20")
            .withEmail("stefan@example.com").withAddress("little india").build();
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller").withGender("MALE").withPhone("8482131")
            .withMeasurement("180_70_80")
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withGender(VALID_GENDER_AMY)
            ...
            .withMeasurement(VALID_MEASUREMENT_AMY)
    ...
    public static List<Person> getTypicalPersons() {
        return new ArrayList<>(Arrays.asList(ALICE, BENSON, CARL, DANIEL, ELLE, FIONA, JOHNSON));
    }
}
