...
public class JsonSerializableAddressBookTest {
    ...
    public void toModelType_typicalMembersFile_success() throws Exception {
        ...
        assertEquals(addressBookFromFile.getPersonList(), typicalMembersAddressBook.getPersonList());
    }
    ...
    public void toModelType_typicalFacilitiesFile_success() throws Exception {
        ...
        assertEquals(addressBookFromFile.getFacilityList(), typicalFacilitiesAddressBook.getFacilityList());
    }
