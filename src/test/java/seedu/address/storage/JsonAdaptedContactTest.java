...
public class JsonAdaptedContactTest {
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedContact person = new JsonAdaptedContact(VALID_CATEGORY_CODE, null, VALID_PHONE, VALID_EMAIL,
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedContact person = new JsonAdaptedContact(VALID_CATEGORY_CODE, VALID_NAME, null, VALID_EMAIL,
                VALID_ADDRESS, VALID_REVIEW, VALID_TAGS, VALID_RATING);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedContact person = new JsonAdaptedContact(VALID_CATEGORY_CODE, VALID_NAME, VALID_PHONE, null,
                VALID_ADDRESS, VALID_REVIEW, VALID_TAGS, VALID_RATING);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedContact person = new JsonAdaptedContact(VALID_CATEGORY_CODE, VALID_NAME, VALID_PHONE, VALID_EMAIL,
