...
class JsonAdaptedLastUpdatedTest {
    ...
    private static final LastUpdatedDate LAST_UPDATED_DATE = new LastUpdatedDate(VALID_LAST_UPDATED_DATE);
    ...
    public void toModelType_invalidLastUpdatedDate_throwsIllegalValueException() throws IllegalValueException {
        JsonAdaptedLastUpdated lastUpdated = new JsonAdaptedLastUpdated(INVALID_LAST_ADDED_DATE);
