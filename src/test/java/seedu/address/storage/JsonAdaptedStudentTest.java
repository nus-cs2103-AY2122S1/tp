...
public class JsonAdaptedStudentTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(INVALID_NAME, VALID_EMAIL, VALID_STUDENTNUMBER, VALID_TAGS,
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(VALID_NAME, INVALID_EMAIL, VALID_STUDENTNUMBER, VALID_TAGS,
                        VALID_ATTENDANCE, VALID_PARTICIPATION);
    ...
    public void toModelType_invalidStudentNumber_throwsIllegalValueException() {
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(VALID_NAME, VALID_EMAIL, INVALID_STUDENTNUMBER, VALID_TAGS,
                        VALID_ATTENDANCE, VALID_PARTICIPATION);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(VALID_NAME, VALID_EMAIL, VALID_STUDENTNUMBER, invalidTags,
                        VALID_ATTENDANCE, VALID_PARTICIPATION);
