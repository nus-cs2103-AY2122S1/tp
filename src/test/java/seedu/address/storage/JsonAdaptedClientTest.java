...
public class JsonAdaptedClientTest {
    ...
    private static final List<JsonAdaptedOrder> VALID_ORDERS = AMY.getOrders().stream()
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedClient client =
                new JsonAdaptedClient(INVALID_NAME, VALID_PHONE_NUMBER, VALID_EMAIL, VALID_ADDRESS, VALID_ORDERS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedClient client =
                new JsonAdaptedClient(null, VALID_PHONE_NUMBER, VALID_EMAIL, VALID_ADDRESS, VALID_ORDERS);
    ...
    public void toModelType_invalidPhoneNumber_throwsIllegalValueException() {
        JsonAdaptedClient client =
                new JsonAdaptedClient(VALID_NAME, INVALID_PHONE_NUMBER, VALID_EMAIL, VALID_ADDRESS, VALID_ORDERS);
    ...
    public void toModelType_nullPhoneNumber_throwsIllegalValueException() {
        JsonAdaptedClient client =
                new JsonAdaptedClient(VALID_NAME, null, VALID_EMAIL, VALID_ADDRESS, VALID_ORDERS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedClient client =
                new JsonAdaptedClient(VALID_NAME, VALID_PHONE_NUMBER, INVALID_EMAIL, VALID_ADDRESS, VALID_ORDERS);
    ...
    public void toModelType_nullEmail_success() throws IllegalValueException {
        JsonAdaptedClient client =
                new JsonAdaptedClient(VALID_NAME, VALID_PHONE_NUMBER, null, VALID_ADDRESS, VALID_ORDERS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedClient client =
                new JsonAdaptedClient(VALID_NAME, VALID_PHONE_NUMBER, VALID_EMAIL, INVALID_ADDRESS, VALID_ORDERS);
