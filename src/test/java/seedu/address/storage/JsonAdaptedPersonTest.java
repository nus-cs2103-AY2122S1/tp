...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_ROLE, VALID_EMPLOYMENT_TYPE, VALID_EXPECTED_SALARY, VALID_EXPERIENCE, VALID_TAGS);
    ...
    public void toModelType_invalidRole_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                INVALID_ROLE, VALID_EMPLOYMENT_TYPE, VALID_EXPECTED_SALARY, VALID_EXPERIENCE, VALID_TAGS);
    ...
    public void toModelType_nullRole_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                null, VALID_EMPLOYMENT_TYPE, VALID_EXPECTED_SALARY, VALID_EXPERIENCE, VALID_TAGS);
    ...
    public void toModelType_invalidEmploymentType_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_ROLE, INVALID_EMPLOYMENT_TYPE, VALID_EXPECTED_SALARY, VALID_EXPERIENCE, VALID_TAGS);
    ...
    public void toModelType_nullEmploymentType_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_ROLE, null, VALID_EXPECTED_SALARY, VALID_EXPERIENCE, VALID_TAGS);
    ...
    public void toModelType_invalidExpectedSalary_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_ROLE, VALID_EMPLOYMENT_TYPE, INVALID_EXPECTED_SALARY, VALID_EXPERIENCE, VALID_TAGS);
    ...
    public void toModelType_nullExpectedSalary_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_ROLE, VALID_EMPLOYMENT_TYPE, null, VALID_EXPERIENCE, VALID_TAGS);
    ...
    public void toModelType_invalidExperience_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_ROLE, VALID_EMPLOYMENT_TYPE, VALID_EXPECTED_SALARY, INVALID_EXPERIENCE, VALID_TAGS);
    ...
    public void toModelType_nullExperience_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_ROLE, VALID_EMPLOYMENT_TYPE, VALID_EXPECTED_SALARY, null, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_ROLE, VALID_EMPLOYMENT_TYPE, VALID_EXPECTED_SALARY, VALID_EXPERIENCE, invalidTags);
