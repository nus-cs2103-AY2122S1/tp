...
public class JsonAdaptedPersonTest {
    ...
    private static final String VALID_SOCIAL_HANDLE = BENSON.getSocialHandle().toString();
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_NATIONALITY,
                        VALID_TUTORIAL_GROUP, VALID_SOCIAL_HANDLE, VALID_GENDER, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                ...
                VALID_SOCIAL_HANDLE, VALID_GENDER, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_invalidTutorialGroup_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_NATIONALITY,
                        INVALID_TUTORIAL_GROUP, VALID_SOCIAL_HANDLE, VALID_GENDER, VALID_REMARK, VALID_TAGS);
    ...
    @Test
    public void toModelType_invalidSocialHandle_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_NATIONALITY,
                        VALID_TUTORIAL_GROUP, INVALID_SOCIAL_HANDLE, VALID_GENDER, VALID_REMARK, VALID_TAGS);
        String expectedMessage = SocialHandle.MESSAGE_CONSTRAINTS;
        assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    }

    @Test
    public void toModelType_nullSocialHandle_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_NATIONALITY, VALID_TUTORIAL_GROUP,
                null, VALID_GENDER, VALID_REMARK, VALID_TAGS);
        String expectedMessage = String.format(MISSING_FIELD_MESSAGE_FORMAT, SocialHandle.class.getSimpleName());
        assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    }
    ...
    public void toModelType_invalidGender_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_NATIONALITY,
                        VALID_TUTORIAL_GROUP, VALID_SOCIAL_HANDLE, INVALID_GENDER, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_nullGender_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_NATIONALITY, VALID_TUTORIAL_GROUP,
                VALID_SOCIAL_HANDLE, null, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_invalidRemark_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_NATIONALITY,
                        VALID_TUTORIAL_GROUP, VALID_SOCIAL_HANDLE, VALID_GENDER, INVALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_nullRemark_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_NATIONALITY, VALID_TUTORIAL_GROUP,
                VALID_SOCIAL_HANDLE, VALID_GENDER, null, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_NATIONALITY,
                        VALID_TUTORIAL_GROUP, VALID_SOCIAL_HANDLE, VALID_GENDER, VALID_REMARK, invalidTags);
