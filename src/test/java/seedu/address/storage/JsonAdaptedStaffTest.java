...
public class JsonAdaptedStaffTest {
    ...
    public void toModelType_validPersonDetails_returnsPerson() throws Exception {
        JsonAdaptedStaff person = new JsonAdaptedStaff(BENSON);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedStaff person = new JsonAdaptedStaff(null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedStaff person = new JsonAdaptedStaff(VALID_NAME, null, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedStaff person = new JsonAdaptedStaff(VALID_NAME, VALID_PHONE, null, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedStaff person = new JsonAdaptedStaff(VALID_NAME, VALID_PHONE, VALID_EMAIL, null, VALID_TAGS);
