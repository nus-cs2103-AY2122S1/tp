...
public class StorageManagerTest {
    ...
    public void setUp() {
        ...
        JsonUserInfoStorage userInfoStorage = new JsonUserInfoStorage(getTempFilePath("info"));
        storageManager = new StorageManager(addressBookStorage, userPrefsStorage, userInfoStorage);
    }
