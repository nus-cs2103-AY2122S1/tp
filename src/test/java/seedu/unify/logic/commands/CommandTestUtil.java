...
public class CommandTestUtil {
    ...
    public static final String VALID_DATE_AMY = "Block 312, Amy Street 1";
    public static final String VALID_DATE_BOB = "Block 123, Bobby Street 3";
    ...
    static {
        DESC_AMY = new EditTaskDescriptorBuilder().withName(VALID_NAME_AMY)
                .withTime(VALID_TIME_AMY).withEmail(VALID_EMAIL_AMY).withDate(VALID_DATE_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditTaskDescriptorBuilder().withName(VALID_NAME_BOB)
                .withTime(VALID_TIME_BOB).withEmail(VALID_EMAIL_BOB).withDate(VALID_DATE_BOB)
