...
public class AdditionalViewTypeTest {
    ...
    public void parse_additionalViewType() {
        ...
        assertEquals(AdditionalViewType.parse(historyCommand), AdditionalViewType.HISTORY);
        ...
        assertEquals(AdditionalViewType.parse(getCommand), AdditionalViewType.GET);

        // Additional View Type works for Show
        assertEquals(AdditionalViewType.parse(showCommand), AdditionalViewType.SHOW);
