...
import static seedu.academydirectory.logic.commands.CommandTestUtil.ADDRESS_DESC_AMY;
import static seedu.academydirectory.logic.commands.CommandTestUtil.ADDRESS_DESC_BOB;
...
import static seedu.academydirectory.logic.commands.CommandTestUtil.INVALID_ADDRESS_DESC;
...
import static seedu.academydirectory.logic.commands.CommandTestUtil.NAME_DESC_BOB;
...
import static seedu.academydirectory.logic.commands.CommandTestUtil.PREAMBLE_NON_EMPTY;
import static seedu.academydirectory.logic.commands.CommandTestUtil.PREAMBLE_WHITESPACE;
...
public class AddCommandParserTest {
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_NAME_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                        + TELEGRAM_DESC_BOB + ADDRESS_DESC_BOB,
                expectedMessage);
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                        + VALID_TELEGRAM_BOB + ADDRESS_DESC_BOB,
                expectedMessage);

        // missing address prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                        + TELEGRAM_DESC_BOB + VALID_ADDRESS_BOB,
                expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_BOB + VALID_PHONE_BOB + VALID_EMAIL_BOB
                        + VALID_TELEGRAM_BOB + VALID_ADDRESS_BOB,
                expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + TELEGRAM_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
