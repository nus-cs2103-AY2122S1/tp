...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonPlannerMdStorage plannerMdStorage =
                new JsonPlannerMdStorage(temporaryFolder.resolve("plannerMd.json"));
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        JsonPlannerMdStorage plannerMdStorage =
                new JsonPlannerMdIoExceptionThrowingStub(temporaryFolder.resolve("ioExceptionPlannerMd.json"));
