...
public class CommandTestUtil {
    ...
    public static final LocalDate FILTER_VALID_START_DATE = LocalDate.of(2021, 10, 20);
    public static final LocalDate FILTER_VALID_END_DATE = LocalDate.of(2021, 11, 20);
