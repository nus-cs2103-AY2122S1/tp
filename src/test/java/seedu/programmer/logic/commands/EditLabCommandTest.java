...
//import static seedu.programmer.logic.commands.CommandTestUtil.VALID_LAB_NAME;
...
//
//    @Test
//    public void execute_LabExists_success() {
//        Student editedStudent = new StudentBuilder().build();
//        EditStudentDescriptor descriptor = new EditStudentDescriptorBuilder(editedStudent).build();
//        Lab originalLab = new Lab(VALID_LAB_NAME, VALID_TOTAL_SCORE);
//        Lab expectedLab = new Lab(VALID_LAB_NAME, VALID_ACTUAL_SCORE, VALID_TOTAL_SCORE);
//        EditLabCommand editLabCommand = new EditLabCommand(INDEX_FIRST_STUDENT, originalLab, VALID_ACTUAL_SCORE);
//
//        String expectedMessage = String.format(EditLabCommand.MESSAGE_ADD_LAB_SUCCESS, editedStudent);
//
//        Model expectedModel = new ModelManager(new ProgrammerError(model.getProgrammerError()), new UserPrefs());
//        expectedModel.setStudent(model.getFilteredStudentList().get(), editedStudent);
//
