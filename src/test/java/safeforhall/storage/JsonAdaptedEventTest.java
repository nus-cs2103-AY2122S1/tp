...
public class JsonAdaptedEventTest {
    ...
    public void toModelType_invalidEventName_throwsIllegalValueException() {
        JsonAdaptedEvent event =
                new JsonAdaptedEvent(INVALID_EVENTNAME, VALID_EVENTDATE, VALID_VENUE, VALID_CAPACITY,
                        VALID_RESIDENTS);
    ...
    public void toModelType_nullEventName_throwsIllegalValueException() {
        JsonAdaptedEvent event = new JsonAdaptedEvent(null, VALID_EVENTDATE, VALID_VENUE, VALID_CAPACITY,
                VALID_RESIDENTS);
    ...
    public void toModelType_invalidEventDate_throwsIllegalValueException() {
        JsonAdaptedEvent event =
                new JsonAdaptedEvent(VALID_EVENTNAME, INVALID_EVENTDATE, VALID_VENUE, VALID_CAPACITY,
                        VALID_RESIDENTS);
    ...
    public void toModelType_nullEventDate_throwsIllegalValueException() {
        JsonAdaptedEvent event = new JsonAdaptedEvent(VALID_EVENTNAME, null, VALID_VENUE, VALID_CAPACITY,
                VALID_RESIDENTS);
    ...
    public void toModelType_invalidVenue_throwsIllegalValueException() {
        JsonAdaptedEvent event =
                new JsonAdaptedEvent(VALID_EVENTNAME, VALID_EVENTDATE, INVALID_VENUE, VALID_CAPACITY,
                        VALID_RESIDENTS);
    ...
    public void toModelType_nullVenue_throwsIllegalValueException() {
        JsonAdaptedEvent event = new JsonAdaptedEvent(VALID_EVENTNAME, VALID_EVENTDATE, null, VALID_CAPACITY,
                VALID_RESIDENTS);
    ...
    public void toModelType_invalidCapacity_throwsIllegalValueException() {
        JsonAdaptedEvent event =
                new JsonAdaptedEvent(VALID_EVENTNAME, VALID_EVENTDATE, VALID_VENUE, INVALID_CAPACITY,
                        VALID_RESIDENTS);
    ...
    public void toModelType_nullCapacity_throwsIllegalValueException() {
        JsonAdaptedEvent event = new JsonAdaptedEvent(VALID_EVENTNAME, VALID_EVENTDATE, VALID_VENUE, null,
                VALID_RESIDENTS);
    ...
    public void toModelType_invalidResidents_throwsIllegalValueException() {
        JsonAdaptedEvent event =
                new JsonAdaptedEvent(VALID_EVENTNAME, VALID_EVENTDATE, VALID_VENUE, VALID_CAPACITY,
                        INVALID_RESIDENTS);
    ...
    public void toModelType_nullResidents_throwsIllegalValueException() {
        JsonAdaptedEvent event = new JsonAdaptedEvent(VALID_EVENTNAME, VALID_EVENTDATE, VALID_VENUE, VALID_CAPACITY,
                null);
