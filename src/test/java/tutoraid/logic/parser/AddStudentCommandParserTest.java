...
public class AddStudentCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        CommandParserTestUtil.assertParseSuccess(parser, STUDENT_NAME_DESC_AMY + STUDENT_NAME_DESC_BOB + STUDENT_PHONE_DESC_BOB
                + PARENT_NAME_DESC_BOB + PARENT_PHONE_DESC_BOB, new AddStudentCommand(expectedStudent));
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        CommandParserTestUtil.assertParseFailure(parser, VALID_STUDENT_NAME_BOB + STUDENT_PHONE_DESC_BOB + PARENT_NAME_DESC_BOB
    ...
    public void parse_invalidValue_failure() {
        ...
        CommandParserTestUtil.assertParseFailure(parser, INVALID_STUDENT_NAME_DESC + STUDENT_PHONE_DESC_BOB + PARENT_NAME_DESC_BOB
                + PARENT_PHONE_DESC_BOB, Name.MESSAGE_CONSTRAINTS);

        // invalid student phone
        CommandParserTestUtil.assertParseFailure(parser, STUDENT_NAME_DESC_BOB + INVALID_STUDENT_PHONE_DESC + PARENT_NAME_DESC_BOB
                + PARENT_PHONE_DESC_BOB, Phone.MESSAGE_CONSTRAINTS);

        // invalid parent name
        CommandParserTestUtil.assertParseFailure(parser, STUDENT_NAME_DESC_BOB + STUDENT_PHONE_DESC_BOB + INVALID_PARENT_NAME_DESC
                + PARENT_PHONE_DESC_BOB, Name.MESSAGE_CONSTRAINTS);

        // invalid parent phone
        CommandParserTestUtil.assertParseFailure(parser, STUDENT_NAME_DESC_BOB + STUDENT_PHONE_DESC_BOB + PARENT_NAME_DESC_BOB
        ...
        // non-empty preamble
        CommandParserTestUtil.assertParseFailure(parser, PREAMBLE_NON_EMPTY + STUDENT_NAME_DESC_BOB + STUDENT_PHONE_DESC_BOB
