...
public class TypicalStudents {
    public static final Student ALICE = new StudentBuilder().withStudentName("Alice Pauline").withStudentPhone("94351234")
            .withParentName("Mrs Tan").withParentPhone("94351253")
            .withProgress("No Progress").withPaymentStatus(false).build();
    public static final Student BENSON = new StudentBuilder().withStudentName("Benson Meier").withStudentPhone("98765423")
            .withParentName("Mrs Meier").withParentPhone("98765432")
            .withProgress("No Progress").withPaymentStatus(true).build();
    public static final Student CARL = new StudentBuilder().withStudentName("Carl Kurz").withStudentPhone("95352563")
            .withParentName("Mr Kurz").withParentPhone("95352567")
            .withProgress("No Progress").withPaymentStatus(false).build();
    public static final Student DANIEL = new StudentBuilder().withStudentName("Daniel Meier").withStudentPhone("87652533")
            .withParentName("Mrs Meier").withParentPhone("98765432")
            .withProgress("No Progress").withPaymentStatus(false).build();
    public static final Student ELLE = new StudentBuilder().withStudentName("Elle Meyer").withStudentPhone("9482224")
            .withParentName("Mrs Meyer").withParentPhone("9482290")
            .withPaymentStatus(false).build();
    public static final Student FIONA = new StudentBuilder().withStudentName("Fiona Kunz").withStudentPhone("9482427")
            .withParentName("Mr Daniel").withParentPhone("9482423")
            .withProgress("No Progress").withPaymentStatus(false).build();
    public static final Student GEORGE = new StudentBuilder().withStudentName("George Best").withStudentPhone("9482442")
            .withParentName("Mrs Kayla").withParentPhone("94824432")
            .withProgress("No Progress").withPaymentStatus(false).build();

    // Manually added
    public static final Student HOON = new StudentBuilder().withStudentName("Hoon Meier").withStudentPhone("8482424")
            .withParentName("Mrs Meier").withParentPhone("98765432")
            .withProgress("No Progress").withPaymentStatus(false).build();
    public static final Student IDA = new StudentBuilder().withStudentName("Ida Mueller").withStudentPhone("8482131")
