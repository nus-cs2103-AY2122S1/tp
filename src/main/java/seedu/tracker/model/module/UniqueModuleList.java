...
public class UniqueModuleList implements Iterable<Module> {
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                || (other instanceof seedu.tracker.model.module.UniqueModuleList // instanceof handles nulls
                && internalList.equals(((seedu.tracker.model.module.UniqueModuleList) other).internalList));
    }
