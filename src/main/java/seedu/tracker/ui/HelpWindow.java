...
public class HelpWindow extends UiPart<Stage> {
    ...
    public static final List<String> commandFormats = Collections.unmodifiableList(Arrays.asList(ADD_COMMAND,
    ...
    public HelpWindow(Stage root) {
        ...
        for (int i = 0; i < HelpWindow.commandFormats.size(); i++) {
            commandFormat += "\n\n" + (i+1) + ". " + HelpWindow.commandFormats.get(i);
        }
