...
public class MainWindow extends UiPart<Stage> {
    ...
    @FXML
    private StackPane appointmentTabPlaceholder;
    ...
    void fillInnerParts() {
        ...
        StatusBarFooter statusBarFooter = new StatusBarFooter(logic.getPlannerMdFilePath());
        statusbarPlaceholder.getChildren().add(statusBarFooter.getRoot());

        CommandBox commandBox = new CommandBox(this::executeCommand);
        commandBoxPlaceholder.getChildren().add(commandBox.getRoot());

        // Add filtered appointment list here
        appointmentPanel = new AppointmentListPanel(logic.getFilteredAppointmentList());
     ...
     *
     * @see seedu.plannermd.logic.Logic#execute(String)
     */
