 ...
 * A patient is considered unique by comparing using {@code Person#isSamePerson(Person)}.
 * As such, adding and updating of persons uses Person#isSamePerson(Person) for equality so
 * as to ensure that the patient being added or updated is unique in terms of identity in the UniquePatientList.
