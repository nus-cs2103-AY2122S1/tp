...
public class SampleDataUtil {
    ...
    public static Patient[] getSamplePatients() {
        return new Patient[]{
            new Patient(new Name("Aaron Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
            ...
            new Patient(new Name("Bobby Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                    ...
                    new Risk("MEDIUM")),
            new Patient(new Name("Charmaine Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
            ...
            new Patient(new Name("Duke Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                    new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), new BirthDate("20/07/1964"),
                    EMPTY_REMARK, getTagSet("family"), new Risk("LOW")),
            new Patient(new Name("Ivan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                    new Address("Blk 47 Tampines Street 20, #17-35"), new BirthDate("25/12/2000"), EMPTY_REMARK,
                    getTagSet("classmates"), new Risk("LOW")),
            new Patient(new Name("Ryan Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
