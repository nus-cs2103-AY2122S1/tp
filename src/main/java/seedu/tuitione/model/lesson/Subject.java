...
public class Subject {
    ...
    public static final String SUBJECT_MESSAGE_CONSTRAINTS = String.format("Subject names should be a single "
            + "alphanumeric word and within %1$d characters", MAXIMUM_SUBJECT_LENGTH);
