...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_STUDENT_DISPLAYED_INDEX = "❌\tIndex Error!\nThe student index cannot be found";
    public static final String MESSAGE_INVALID_LESSON_DISPLAYED_INDEX = "❌\tIndex Error!\nThe lesson index cannot be found";
    ...
    public static final String MESSAGE_LESSON_FOUND_OVERVIEW = "ℹ\tUpdate:\n%1$d lessons(s) found!";
    public static final String MESSAGE_STUDENTS_FOUND_OVERVIEW = "ℹ\tUpdate:\n%1$d student(s) found!";
}
