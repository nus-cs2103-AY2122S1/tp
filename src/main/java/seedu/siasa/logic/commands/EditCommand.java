...
public class EditCommand extends Command {
    ...
    public static final String MESSAGE_EDIT_CONTACT_SUCCESS = "Edited Client: %1$s";
    public static final String MESSAGE_NOT_EDITED = "At least one field to edit must be provided.";
    public static final String MESSAGE_DUPLICATE_CONTACT = "This client already exists in the address book.";
