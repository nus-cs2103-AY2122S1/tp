...
import seedu.fast.commons.core.Config;
import seedu.fast.commons.core.LogsCenter;
import seedu.fast.commons.core.Version;
import seedu.fast.commons.exceptions.DataConversionException;
import seedu.fast.commons.util.ConfigUtil;
...
public class MainApp extends Application {
    ...
    private Model initModelManager(Storage storage, ReadOnlyUserPrefs userPrefs) {
        ...
        try {
            fastOptional = storage.readFast();
            if (!fastOptional.isPresent()) {
                logger.info("Data file not found. Will be starting with a sample Fast");
            }
            initialData = fastOptional.orElseGet(SampleDataUtil::getSampleFast);
        } catch (DataConversionException e) {
            logger.warning("Data file not in the correct format. Will be starting with an empty Fast");
            initialData = new Fast();
        } catch (IOException e) {
            logger.warning("Problem while reading from the file. Will be starting with an empty Fast");
            initialData = new Fast();
        }
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting Fast " + MainApp.VERSION);
        ui.start(primaryStage);
    }

    @Override
    public void stop() {
        logger.info("============================ [ Stopping Fast ] =============================");
        try {
