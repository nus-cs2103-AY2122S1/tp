    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                ...
                getTagSet("classmates", "LifeInsurance", "HealthInsurance"),
                new Appointment("11 May 2023", "", ""),
            ...
            new Person(new Name("Thomas Lim"), new Phone("98902563"), new Email("thomaslim@example.com"),
                ...
                getTagSet("HighPriority", "acquaintance", "MotorInsurance"),
                new Appointment("12 Dec 2021", "1430", "Buono Vista"),
                new AppointmentCount("0")),
