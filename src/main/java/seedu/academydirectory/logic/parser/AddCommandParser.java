...
import static seedu.academydirectory.logic.commands.AddCommand.INVALID_FORMAT;
...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_NAME, PREFIX_EMAIL, PREFIX_TELEGRAM)
            ...
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT, INVALID_FORMAT));
        }
