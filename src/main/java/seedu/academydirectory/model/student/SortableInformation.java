...
public abstract class SortableInformation implements Information {
    ...
    /**
     * Returns true if a given string is a valid SortableInformation by checking if it is contained in
    ...
    /**
     * This nested class is to be used for the SortableInformation class to determine the order in which to sort.
     */
