...
public class Messages {
    ...
    public static final String MESSAGE_HELP_NOT_EXIST = "Error: No instruction exist for the command";

    public static final String GENERAL_HELP_MESSAGE = "## Command summary\n"
            + "\n"
            + "Action | Format, Examples\n"
            + "--------|------------------\n"
            + "**Add** | `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [t/TAG]…\u200B` <br> e.g., "
