...
public class CliSyntax {
    ...
    public static final Prefix PREFIX_SPECIAL_REQUESTS = new Prefix("sr/");
    public static final Prefix PREFIX_LP = new Prefix("lp/");
    ...
    public static final Prefix PREFIX_SHIFT = new Prefix("sh/");
