...
/**
 * Parses input arguments and creates a new RemoveEventCommand object
 */
public class RemoveEventCommandParser implements Parser<RemoveEventCommand> {

    /**
     * Parses the given {@code String} of arguments in the context of the RemoveEventCommand
     * and returns a RemoveEventCommand object for execution.
