...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        if (argMultimap.getValue(PREFIX_CATEGORY_CODE).isPresent()) {
            editContactDescriptor.setCategoryCode(ParserUtil.parseCategory(argMultimap.getValue(PREFIX_CATEGORY_CODE)
                    .get()));
        }
        ...
        if (argMultimap.getValue(PREFIX_RATING).isPresent()) {
            editContactDescriptor.setRating(argMultimap.getValue(PREFIX_RATING).get().equals("")
        ...
        if (argMultimap.getValue(PREFIX_REVIEW).isPresent()) {
            editContactDescriptor.setReview(ParserUtil.parseReview(argMultimap.getValue(PREFIX_REVIEW).get()));
        }
