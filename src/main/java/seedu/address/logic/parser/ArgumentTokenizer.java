...
public class ArgumentTokenizer {
    ...
    public static ArgumentMultimap tokenize(String argsString, Flag... flags) {
        List<FlagPosition> positions = findAllPrefixPositions(argsString, flags);
     ...
     */
    private static List<FlagPosition> findAllPrefixPositions(String argsString, Flag... flags) {
     ...
     */
    private static List<FlagPosition> findPrefixPositions(String argsString, Flag flag) {
    ...
    private static ArgumentMultimap extractArguments(String argsString, List<FlagPosition> flagPositions) {
        ...
        for (int i = 0; i < flagPositions.size() - 1; i++) {
            ...
            Flag argFlag = flagPositions.get(i).getPrefix();
    ...
    private static String extractArgumentValue(String argsString,
        ...
        Flag flag = currentFlagPosition.getPrefix();
