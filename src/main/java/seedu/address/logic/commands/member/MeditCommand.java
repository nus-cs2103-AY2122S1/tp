...
public class MeditCommand extends Command {
    ...
    public static final String MESSAGE_DUPLICATE_MEMBER = "This member already exists in the Ailurus.";
    ...
    private static Member createEditedMember(Member memberToEdit, EditMemberDescriptor editMemberDescriptor) {
        ...
        Email updatedEmail = editMemberDescriptor.getEmail().orElse(memberToEdit.getEmail().orElse(null));
        Address updatedAddress = editMemberDescriptor.getAddress().orElse(memberToEdit.getAddress().orElse(null));
