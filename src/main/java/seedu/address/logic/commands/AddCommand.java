...
public class AddCommand extends Command {
    ...
    public static final String MESSAGE_ALL_COMPULSORY_FIELDS_MISSING = "The Name, Github and Telegram fields, "
            + "are compulsory!";
    public static final String MESSAGE_NAME_GITHUB_FIELD_MISSING = "The Name and Github fields are compulsory!";
    public static final String MESSAGE_NAME_TELEGRAM_FIELD_MISSING = "The Name and Telegram fields are compulsory!";
    public static final String MESSAGE_GITHUB_TELEGRAM_FIELD_MISSING = "The Github and Telegram fields are compulsory!";
