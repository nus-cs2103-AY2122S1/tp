...
public class SetDefaultShiftTimeCommand extends Command {
    public static final String COMMAND_WORD = "setDefaultShiftTime";
    ...
    public SetDefaultShiftTimeCommand(LocalTime[] timings) {
