...
public class EditCommand extends Command {
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        if (!personToEdit.isSamePerson(editedPerson)) {
            List<TuitionClass> enrolled = editedPerson
                    .getClasses().getClasses().stream().map(id -> model.getClassById(id)).collect(Collectors.toList());
            for (TuitionClass c: enrolled) {
                c.getStudentList().changeStudentName(personToEdit.getName().fullName, editedPerson.getName().fullName);
            }
        }
    ...
    private static Person createEditedPerson(Person personToEdit,
        ...
        return new Person(updatedName, updatedPhone, updatedEmail, updatedAddress,
                updatedRemark, personToEdit.getTags(), personToEdit.getClasses());
    }
