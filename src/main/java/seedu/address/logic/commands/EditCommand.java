...
public class EditCommand extends Command {
    ...
    public static final String MESSAGE_EDIT_PROFILE_DESCRIPTION_CANNOT_BE_EMPTY = "Edit profile description cannot be empty!";
    public static final String MESSAGE_EDIT_PROFILE_PARAMETERS_CANNOT_BE_EMPTY = "Name, Telegram and GitHub parameters cannot be empty!";
    public static final String MESSAGE_EDIT_PROFILE_NAME_CANNOT_BE_EMPTY = "Name to be edited cannot be empty!";
    public static final String MESSAGE_EDIT_PROFILE_TELEGRAM_CANNOT_BE_EMPTY = "Telegram handle to be edited cannot be empty!";
    public static final String MESSAGE_EDIT_PROFILE_GITHUB_CANNOT_BE_EMPTY = "GitHub username to be edited cannot be empty!";
