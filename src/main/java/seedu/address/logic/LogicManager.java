...
import seedu.address.logic.parser.TeachingAssistantBuddyParser;
...
public class LogicManager implements Logic {
    ...
    private final TeachingAssistantBuddyParser teachingAssistantBuddyParser;
    ...
    public CommandResult execute(String commandText) throws CommandException, ParseException {
        ...
        Command command = teachingAssistantBuddyParser.parseCommand(commandText);
        commandResult = command.execute(model);

        try {
            storage.saveTeachingAssistantBuddy(model.getBuddy());
