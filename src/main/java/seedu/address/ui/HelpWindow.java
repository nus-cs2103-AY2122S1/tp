...
public class HelpWindow extends UiPart<Stage> {
    ...
    private static final String ADD_AND_REMOVE_TAGS_SIMULTANEOUSLY_FEATURE_NAME = "To Add and Remove Tag(s) Simultaneously";
    private static final String ADD_AND_REMOVE_TAGS_SIMULTANEOUSLY_FEATURE_COMMAND = "tag <INDEX> a/<TAG_TO_ADD> [MORE_TAGS] r/<TAG_TO_REMOVE> [MORE_TAGS]";
