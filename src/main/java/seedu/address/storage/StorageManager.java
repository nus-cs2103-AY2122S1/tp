...
public class StorageManager implements Storage {
    ...
    @Override
    public Optional<ReadOnlyConthacks> readAddressBook() throws DataConversionException, IOException {
        return readAddressBook(addressBookStorage.getAddressBookFilePath());
    }

    @Override
    public Optional<ReadOnlyConthacks> readAddressBook(Path filePath) throws DataConversionException, IOException {
