...
public interface ApplicantBookStorage {
     ...
     */
    Optional<ReadOnlyApplicantBook> readApplicantBook(ReadOnlyPositionBook positionBook) throws DataConversionException, IOException;

    /**
     * @see #getApplicantBookFilePath()
     */
    Optional<ReadOnlyApplicantBook> readApplicantBook(Path filePath, ReadOnlyPositionBook positionBook) throws DataConversionException, IOException;
