...
public class AddressBook implements ReadOnlyAddressBook {
    ...
    /**
     * Replaces the contents of the person list with {@code staffs}.
     * {@code persons} must not contain duplicate persons.
     */
    public void setPersons(List<Person> staffs) {
        this.staffs.setPersons(staffs);
    }
     ...
     */
    public boolean hasPerson(Person staff) {
    ...
    public void setPerson(Person target, Person editedStaff) {
        ...
        staffs.setPerson(target, editedStaff);
    }
