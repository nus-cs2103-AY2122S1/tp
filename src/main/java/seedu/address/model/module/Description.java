...
public class Description {
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                || (other instanceof seedu.address.model.module.Description // instanceof handles nulls
                && value.equals(((seedu.address.model.module.Description) other).value)); // state check
    }
