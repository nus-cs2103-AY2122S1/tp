...
public class UniqueModuleList implements Iterable<Module> {
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                || (other instanceof seedu.address.model.module.UniqueModuleList // instanceof handles nulls
                && internalList.equals(((seedu.address.model.module.UniqueModuleList) other).internalList));
    }
