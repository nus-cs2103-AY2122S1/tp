...
public class UniqueStudentList implements Iterable<Student> {
     ...
     * @param toGet the student to be gotten.
     * @return a student object with the same name as the input.
     */
    public Student getSameNameStudent(Student toGet) {
        requireAllNonNull(toGet);
        for (Student student : internalList) {
            if (student.getSameNameStudent(toGet) != null) {
                Student returnStudent = student.getSameNameStudent(toGet);
