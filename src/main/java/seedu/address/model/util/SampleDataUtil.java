    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Person(new ClientId("5"), new Name("Roy Balakrishnan"), new Phone("92624417"),
                ...
                new LastMet("24-01-2021"), getTagSet("colleagues"))
        };
    }
