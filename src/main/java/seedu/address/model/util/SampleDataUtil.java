...
public class SampleDataUtil {
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Person(new ClientId("1"), new Name("Charlotte Oliveiro"), new Phone("93210283"),
                new Email("charlotte@example.com"), new Address("Blk 11 Ang Mo Kio Street 74, #11-04"),
                new RiskAppetite("1"), new DisposableIncome("500"), getTagSet("neighbours")),
            new Person(new ClientId("2"), new Name("David Li"), new Phone("91031282"),
                new Email("lidavid@example.com"), new Address("Blk 436 Serangoon Gardens Street 26, #16-43"),
                new RiskAppetite("1"), new DisposableIncome("500"), getTagSet("family")),
            new Person(new ClientId("3"), new Name("Irfan Ibrahim"), new Phone("92492021"),
                new Email("irfan@example.com"), new Address("Blk 47 Tampines Street 20, #17-35"),
                new RiskAppetite("1"), new DisposableIncome("500"), getTagSet("classmates")),
            new Person(new ClientId("4"), new Name("Roy Balakrishnan"), new Phone("92624417"),
