...
public class SampleDataUtil {
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("e0123457@u.nus.edu"),
            ...
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("e0123458@u.nus.edu"),
            ...
            new Person(new Name("David Li"), new Phone("91031282"), new Email("e0123459@u.nus.edu"),
            ...
            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("e0123450@u.nus.edu"),
            ...
            new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("e0123451@u.nus.edu"),
