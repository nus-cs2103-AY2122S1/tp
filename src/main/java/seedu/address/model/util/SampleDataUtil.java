...
public class SampleDataUtil {
    ...
    public static Person[] getSamplePersons() {
        return new Person[]{
            ...
            new Person(new CategoryCode("att"), new Name("Singapore Botanic Gardens"), new Phone("90807060"),
            ...
            new Person(new CategoryCode("att"), new Name("Singapore Flyer"), new Phone("9189118"),
            ...
            new Person(new CategoryCode("att"), new Name("Clarke Quay"), new Phone("91919191"),
            ...
            new Person(new CategoryCode("tpt"), new Name("Big Bus Tours"), new Phone("63386877"),
                    ...
                    "bus"), new Rating("2")),
            new Person(new CategoryCode("com"), new Name("Bugis Street"), new Phone("63386222"),
            ...
            new Person(new CategoryCode("acc"), new Name("The Pod Boutique Capsule Hotel"), new Phone("62988505"),
