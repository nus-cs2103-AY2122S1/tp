...
public class SampleDataUtil {
    ...
    public static Contact[] getSampleContacts() {
        return new Contact[]{
            ...
            new Contact(new CategoryCode("oth"), new Name("Esso Changi"), new Phone("62712705"),
                    new Email("essochangi@example.com"), new Address("396 Changi Road, Singapore 98837."),
                    new Review("Not too bad, good customer service"),
                    getTagSet("kiosk", "break"), new Rating("3")),
            ...
            new Contact(new CategoryCode("fnb"), new Name("Green on Earth Vegetarian Cafe"),
                ...
                new Review("Very good"), getTagSet("vegetarian", "central"), new Rating("1")),
            new Contact(new CategoryCode("fnb"), new Name("Moosehead Kitchen Bar"),
                ...
                new Review("Excellent"), getTagSet("vegetarian", "restaurant"), new Rating("1")),
            ...
            new Contact(new CategoryCode("fnb"), new Name("HANS IM GLUCK German Burgergrill"),
                ...
                new Review("Excellent burgers"), getTagSet("burger", "vegetarian"), new Rating("2")),
            ...
            new Contact(new CategoryCode("tpt"), new Name("Big Bus Tours"), new Phone("63386877"),
                    ...
                    "bus"), new Rating("2")),
            new Contact(new CategoryCode("tpt"), new Name("Comfort Delgro"), new Phone("63386875"),
                    new Email("comfortDelgro@example.com"),
                    new Address("3 Temasek Blvd, #01-330 Suntec City, Singapore 038983"),
                    new Review("Hire a cab anywhere in Singapore!"), getTagSet("tour", "citytour", "guided",
                    "bus"), new Rating("2")),
