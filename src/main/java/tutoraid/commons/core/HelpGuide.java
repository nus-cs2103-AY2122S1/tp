...
public class HelpGuide {
    ...
    public static final String OVERVIEW = "TutorAid is a desktop app for private tutors to match their students’ contacts, " +
            "optimized for use via a Command Line Interface (CLI) while still having the benefits of a Graphical User " +
            "Interface (GUI). If you can type fast, TutorAid can get your student management tasks done faster than " +
    ...
    public static final String ADD_S_COMMAND = "add -s sn/STUDENT_NAME [sp/STUDENT_PHONE] [pn/PARENT_NAME] [pp/PARENT_PHONE]";
    ...
    public static final String LIST_DESC = "Shows a list of all students in TutorAid in the order that they were added.";
    public static final String LIST_GENERAL_COMMAND = "list [-a]";
    public static final String LIST_EXAMPLE = "list";
    public static final String LIST_EXAMPLE_DESC = " displays all students in TutorAid while showing only their name " +
            "and list index. ";
    ...
    public static final String EDIT_S_COMMAND = "edit STUDENT_INDEX [sn/STUDENT_NAME] [sp/STUDENT_PHONE] [pn/PARENT_NAME]" +
            " [pp/PARENT_PHONE]";
    public static final String EDIT_S_EXAMPLE = "edit 2 pp/91112222";
    public static final String EDIT_S_EXAMPLE_DESC = " changes the 2nd student’s parent contact number in TutorAid to " +
            "91112222.";

    public static final String VIEW_S_TITLE = "Viewing a student";
    public static final String VIEW_S_DESC = "Displays the specified student’s name, phone number, progress and payment " +
            "status, along with their parent’s name and phone number.";
    ...
    public static final String PAID_DESC = "Sets the payment status of the specified student to paid for the current " +
            "month.";
    ...
    public static final String EDIT_DATA_DESC2 = "Advanced users are welcome to update data directly by editing that " +
            "data file.";
    ...
    public static final String FAQ_A = "A: Install the app in the other computer and overwrite the empty data file it " +
            "creates with the file that contains the data of your previous TutorAid home folder.";
