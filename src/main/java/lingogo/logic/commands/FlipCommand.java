...
/**
 * Shows or hide the English phrase for the flashcard with the specified index
 */
public class FlipCommand extends Command {

    public static final String COMMAND_WORD = "flip";
    public static final String FLIP_COMMAND_DESCRIPTION = "Toggles the flashcard to either show or hide its English"
            + " phrase";
