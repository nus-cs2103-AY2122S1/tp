package dash.commons.core.index;
...
public class Index {
     ...
     *
     * @param zeroBasedIndex The given zero-based index.
     * @return An Index object corresponding to the input.
     */
     ...
     *
     * @param oneBasedIndex The given one-based index.
     * @return An Index object corresponding to the input.
     */
