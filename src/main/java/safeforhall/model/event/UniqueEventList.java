...
public class UniqueEventList implements Iterable<Event> {
    ...
    public void setEvents(safeforhall.model.event.UniqueEventList replacement) {
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                || (other instanceof safeforhall.model.event.UniqueEventList // instanceof handles nulls
                && internalList.equals(((safeforhall.model.event.UniqueEventList) other).internalList));
    }
