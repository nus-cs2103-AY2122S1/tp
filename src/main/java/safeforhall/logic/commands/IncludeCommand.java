...
public class IncludeCommand extends Command {
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        String combinedDisplayString = event.getCombinedDisplayString(currentResidents, toAdd);
        String combinedStorageString = event.getCombinedStorageString(currentResidents, toAdd);
