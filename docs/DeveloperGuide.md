...
1. Deleting a contact while some contacts are being shown
    ...
    1. Test Case: `delete 1`<br>
       Expected: First contact that is being viewed is deleted from the list. Details of the deleted contact are shown in the status message. The timestamp in the status bar is updated.
