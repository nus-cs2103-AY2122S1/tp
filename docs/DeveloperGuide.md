...
| `* * *`  | admin in a hall/ residence                 | retrieve all residents whose FETs that are due within a given eventDate                                    | ensure residents do not miss their FET deadlines by reminding them to do their FETs                                                   |
...
| `* * *`  | admin in a hall/ residence                 | add a resident's last FET eventDate                                                                        | track and be aware of the new residents’ FET progress                                                                                 |
| `* * *`  | admin in a hall/ residence                 | edit a resident's last FET eventDate                                                                       | update the current residents’ last FET dates when they take a new FET                                                                 |
...
| `* * *`  | admin in a hall/ residence                 | check the eventDate of the events                                                                          | identify who was in contact with the infected person on the day of the event                                                          |
...
1. Actor filters residents, specifying desired FET due eventDate.
