...
The group to be added to is referenced to by it's unique name by the user, and the command gets a reference to this `Group` by finding a group with the same name in the list.
