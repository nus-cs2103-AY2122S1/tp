...
### <a name="UI component"></a> **2. UI component**
...
### <a name="Logic component"></a> **3. Logic component**
...
### <a name="Model component"></a> **4. Model component**
...
### <a name="Storage component"></a> **5. Storage component**
...
### <a name="add student"></a> **1. `Add` Student Feature**
...
### <a name="filter student"></a> **2. `Filter` Student List Feature**
...
### <a name="show lab"></a> **3. `Show` Lab Results Feature**
...
### <a name="edit lab"></a> **4. `EditLab` Feature**
...
### <a name="download data"></a> **5. `Download` Data Feature**
...
### <a name="purge data"></a> **6. `Purge` Feature**
...
### <a name="undoredo"></a> **7. \[Proposed\] Undo/redo feature**
...
### <a name="Product Scope"></a> **1. Product Scope**
...
#### <a name="Use Case1"></a> **1. Use case: UC1 Purge/Delete all sample student records**
...
#### <a name="Use Case2"></a> **2. Use case: UC2 Create a student record**
...
#### <a name="Use Case3"></a> **3. Use case: UC3 Upload student records**
...
#### <a name="Use Case4"></a> **4. Use case: UC4 View a student record**
...
#### <a name="Use Case5"></a> **5. Use case: UC5 Delete a student record**
...
#### <a name="Use Case6"></a> **6. Use case: UC6 Update a student record**
...
#### <a name="Use Case7"></a> **7. Use case: UC7 Download student records**
...
#### <a name="Use Case8"></a> **8. Use case: UC8 Create a lab record**
...
#### <a name="Use Case9"></a> **9. Use case: UC9 Edit a lab record**
...
#### <a name="Use Case10"></a> **10. Use case: UC10 View dashboard of student records**
...
### <a name="Launch and Shutdown"></a>1. Launch and Shutdown
...
### <a name="Del student"></a>2. Deleting a Student
...
### <a name="show lab student"></a>3. Show a Student's Lab Results
...
### <a name="upload-data"></a>4. Upload Data
...
### <a name="download-data"></a>5. Download Data
...
### <a name="dashboard"></a>6. Dashboard
...
### <a name="Challenges Faced"></a>1. Challenges Faced and Achievements Made
