...
* When editing tags, the existing tags of the person will be replaced i.e. editing of tags is not cumulative.
...
Removes one or more existing tags from an existing person in the address book.
