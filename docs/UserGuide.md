...
* Flags such as `-contacts` and `-folders` are part of the command word and must be placed immediately after the main command word<br>
...
**Add multiple contacts to folder** | `echo INDEX [INDEX]... >> FOLDER_NAME` <br> e.g. `echo 3 4 1 9 10 >> CS2103`
