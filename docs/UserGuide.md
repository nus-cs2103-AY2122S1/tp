...
* [Add task : `add`](#adding-a-task-add)
* [Edit task : `edit`](#editing-a-task-edit)
* [Delete task : `rm`](#deleting-a-task-rm)
* [Mark task as done : `donetask`](#marking-a-task-as-done-donetask)
* [Mark task as not done : `undotask`](#marking-a-task-as-not-done-undotask)
...
* [Clearing all entries : `clear`](#clearing-the-screen-clear)
