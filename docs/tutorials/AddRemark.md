...
![Output displayed](../images/tutorial/add-remark/RemarkHello.png)
...
![The relationship between RemarkCommand and Command](../images/tutorial/add-remark/CommandInterface.png)
...
Create a `RemarkCommandParser` class in the `seedu.academydirectory.logic.parser` package. The class must extend the `Parser` interface.

![The relationship between Parser and RemarkCommandParser](../images/tutorial/add-remark/ParserInterface.png)
...
Create a new `Remark` in `seedu.academydirectory.model.student`. Since a `Remark` is a field that is similar to `Address`, we can reuse a significant bit of code.
...
Simply add the following to [`seedu.academydirectory.ui.StudentCard`](https://github.com/se-edu/addressbook-level3/commit/850b78879582f38accb05dd20c245963c65ea599#diff-0c6b6abcfac8c205e075294f25e851fe).
...
![$remark shows up in each entry](../images/tutorial/add-remark/$Remark.png)
...
![The remark label is bound properly!](../images/tutorial/add-remark/RemarkBound.png)
...
![Congratulations!](../images/tutorial/add-remark/RemarkComplete.png)
...
![Using the context menu to jump to tests](../images/tutorial/add-remark/ContextMenu.png)

Then, create a test for the `execute` method.

![Creating a test for `execute`.](../images/tutorial/add-remark/CreateTest.png)
