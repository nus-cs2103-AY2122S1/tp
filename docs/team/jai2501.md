...
* **New Feature**: Added a keyboard shortcut that allows the user to open the User Profile Window via `Command/Ctrl + P`.

* **New Feature**: Added a GitHub Utility Class.
  ...
  * Credits: [Atin](https://github.com/crypto-code) and I contributed to this.
