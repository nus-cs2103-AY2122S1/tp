...
* **New Feature**: Added ability to show doctors and appointments information in the UI ([#55](https://github.com/AY2122S1-CS2103T-T11-3/tp/pull/55), [#85](https://github.com/AY2122S1-CS2103T-T11-3/tp/pull/85), [#104](https://github.com/AY2122S1-CS2103T-T11-3/tp/pull/104))
   ...
   * Highlights: There was some discussion in our group initially about how the doctors and patients list should be displayed. Some of us wanted the patient and doctor list to be displayed individually while others wanted it to be displayed in a tab which can be switched betweeen the patient and doctor list. There was valid arguments on both sides, but in the end we decided that the latter approach would be better.
...
* **New Feature**: Added ability for users to list the current day's appointments ([#115](https://github.com/AY2122S1-CS2103T-T11-3/tp/pull/115))
   ...
   * Justification: The clinic receptionist 
