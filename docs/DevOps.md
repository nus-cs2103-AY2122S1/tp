...
1. Get the Markdown code for the Codecov badge provided in `Settings > Badges` and update the `docs/index.md` of your repo with it so that the badge [![codecov](https://codecov.io/gh/AY2122S1-CS2103T-T09-2/tp/branch/master/graph/badge.svg?token=SXAFM8BDTQ)](https://codecov.io/gh/AY2122S1-CS2103T-T09-2/tp) in that page reflects the coverage of your project.
